...
import { addRow, deleteRow } from "@/redux/slice";
...
{s.primaryVariantImg?(<div className="flex flex-col justify-center items-center gap-2">
<img src={s.primaryVariantImg} className="max-w-[100px] h-[130px] w-auto object-contain"></img>
<p>{s.primaryVariantDesc}</p>
</div>):<span className="border-[1px] border-gray-200 p-1 rounded-md px-3">+ Add Design</span>}
</div>
</td>
<td className="p-6 border-r border-gray-200">
<div className="bg-white border-dashed border-gray-200 border-[1px] px-2 py-4 h-48 rounded-md  flex flex-wrap items-center gap-2 justify-center text-sm">
{s.variant2Img?(<div className="flex flex-col justify-center items-center gap-2">
<img src={s.variant2Img} className="max-w-[100px] h-[130px] w-auto object-contain"></img>
<p>{s.variant2Desc}</p>
</div>):<span className="border-[1px] border-gray-200 p-1 rounded-md px-3">+ Add Design</span>}
</div>
</td>
<td className="p-6 text-3xl"><div className="flex m-0 items-center justify-center cursor-pointer"><span className="bg-white p-1 px-3 rounded-md border-[1px] border-gray-200">+</span></div></td>
</tr>
))}
<tr>
